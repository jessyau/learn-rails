...
// Define a factory to create queue stubs. These are placeholders for the "real"
// methods in analytics.js so that you never have to wait for the library
// to load asynchonously to actually track things. The 'method' is always the
...
// analytics integrations you've thurned on for your account. Boosh!
window.analytics.load('oXZOyN9XKsvPZct0iofvIHBiiSfM5cPF');
